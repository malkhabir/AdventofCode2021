...
print(sumForwards, sumAims, sumDepths)
print("We have a horizontal position of {0} and a depth of {1} (Multiplying these together produces {2}.)" \
      .format(sumForwards, sumDepths,(sumForwards*sumDepths)))
